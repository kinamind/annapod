...
const translations: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "teams.title": "团队与比赛",
    "teams.subtitle": "创建团队、组织比赛，并查看成员训练情况",
    "teams.tab.mine": "我的团队/比赛",
    "teams.tab.create": "创建",
    "teams.tab.join": "加入",
    "teams.kind.team": "团队",
    "teams.kind.competition": "比赛",
    "teams.create.success": "创建成功",
    "teams.join.success": "加入成功",
  },
  en: {
    ...
    "nav.teams": "Teams & Events",
    "nav.teams.desc": "Group training and competitions",
    ...
    "teams.subtitle": "Create teams, organize competitions, and review member progress",
    "teams.tab.mine": "My Teams",
    "teams.tab.create": "Create",
    "teams.tab.join": "Join",
    "teams.kind.team": "Team",
    "teams.kind.competition": "Competition",
    "teams.create.success": "Created successfully",
    "teams.join.success": "Joined successfully",
  },
};
